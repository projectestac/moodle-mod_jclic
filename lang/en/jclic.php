...
$string['jclicfieldset'] = 'Custom example fieldset';
$string['jclicname'] = 'jclic name';
$string['jclicname_help'] = 'This is the content of the help tooltip associated with the jclicname field. Markdown syntax is supported.';
$string['jclic'] = 'jclic';
